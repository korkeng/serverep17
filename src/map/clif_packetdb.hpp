...
// 2018-04-18bRagexeRE
	...
	packet(0x0B8F, 6);
	parseable_packet(HEADER_CZ_CLOSE_REFORM_UI, sizeof(PACKET_CZ_CLOSE_REFORM_UI), clif_parse_close_reform_ui, 0);
	parseable_packet(HEADER_CZ_REFORM_UI_REFORM, sizeof(PACKET_CZ_REFORM_UI_REFORM), clif_parse_reform_ui_reform, 0);
#endif

#if PACKETVER >= 20201118
	packet(HEADER_ZC_OPEN_ENCHANT_UI, sizeof(PACKET_ZC_OPEN_ENCHANT_UI));
	parseable_packet(HEADER_CZ_CLOSE_ENCHANT_UI, sizeof(PACKET_CZ_CLOSE_ENCHANT_UI), clif_parse_close_enchant_ui, 0);
	parseable_packet(HEADER_CZ_ENCHANT_SIMPLE, sizeof(PACKET_CZ_ENCHANT_SIMPLE), clif_parse_enchant_simple, 0);
	parseable_packet(HEADER_CZ_ENCHANT_PERFECT, sizeof(PACKET_CZ_ENCHANT_PERFECT), clif_parse_enchant_perfect, 0);
	parseable_packet(HEADER_CZ_ENCHANT_UPGRADE, sizeof(PACKET_CZ_ENCHANT_UPGRADE), clif_parse_enchant_upgrade, 0);
	parseable_packet(HEADER_CZ_ENCHANT_RESET, sizeof(PACKET_CZ_ENCHANT_RESET), clif_parse_enchant_reset, 0);
	packet(HEADER_ZC_ENCHANT_ACK, sizeof(PACKET_ZC_ENCHANT_ACK));
#endif

#if PACKETVER >= 20201202
	packet(HEADER_ZC_REPUTE_LIST, -1);
#endif

...
#define MAX_SKILL 1614 ///Maximum skill can be hold by Player, Homunculus, & Mercenary (skill list) AND skill_db limit
...
#endif
#define MAX_REPUTATIONS 3 /// Max reputations
...
struct mmo_charstatus {
	...
	s_reputation reputations[MAX_REPUTATIONS];
};
